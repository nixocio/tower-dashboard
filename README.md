...
```bash
curl -d '{"tower":"devel", "url":"https://your.job.runner.com/job/1", "component":"install", "status":"FAILURE", "tls":0, "deploy":"standalone", "platform":"rhel-7.7-x86_64", "ansible": "devel"}' -H 'Content-t
